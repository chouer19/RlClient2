...
class MPC:
    ...
    def iterative_linear_mpc_control(self, xref, x0):
        """
    ...
    def calc_ref_trajectory(self):
        ...
        self.vehicle.errorDis = dis
        self.vehicle.errorYaw = pi_2_pi(self.state.yaw - self.road.cyaw[ind])
    ...
    def control_steer(self):
        ...
        self.iterative_linear_mpc_control( xref, x0)
